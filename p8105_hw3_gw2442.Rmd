...
make a two-panel plot showing (i) tmax vs tmin for the full dataset (not that  scatterplot may not be the best option); and (ii) make a plot showing the distribution of snowfall values greater than 0 and less than 100 separately by year 
